...
import { Bell, Globe, User, Settings, LogOut, MessageSquare, Check, Calendar, Search, Filter, Phone, Mail, ExternalLink, MoreVertical, Eye, Edit, Trash2, Download } from "lucide-react";
                  ...
                  {filteredBusinesses.length === 0 ? (
                    ...
                    filteredBusinesses.map((business) => (
                      <tr key={business.id} className="border-b hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4 text-gray-700">{business.location}</td>
                        <td className="py-3 px-4">
                        ...
                        <td className="py-3 px-4 text-gray-700">
                          {business.lastContact ? new Date(business.lastContact).toLocaleDateString() : 'Never'}
                        </td>
                        <td className="py-3 px-4">
